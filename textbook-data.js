...
const TEXTBOOK_CHAPTERS = [
  ...
  // =========================================================
  // KATAKANA — chapters grouped by rows (no row-rulesets exist
  // so drill points to full_kata)
  // =========================================================

  {
    id: "k_vowels",
    customChars: ["ア","イ","ウ","エ","オ"],
    drillRulesetId: "full_kata",
    script: "katakana",
  ...
  {
    id: "k_yw_row",
    customChars: ["ヤ","ユ","ヨ","ラ","リ","ル","レ","ロ","ワ","ヲ","ン"],
    drillRulesetId: "full_kata",
    script: "katakana",
